...
| [house_of_tangerine.c](glibc_2.39/house_of_tangerine.c) |  | Exploiting the Top Chunk (Wilderness) in order to gain arbitrary code execution using tcache poisoning | >= 2.26 |  | [PicoCTF 2024- high frequency troubles](https://play.picoctf.org/practice/challenge/441?category=6&page=1&search=high%20frequency%20troubles) |
