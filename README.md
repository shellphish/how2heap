...
| [house_of_roman.c](glibc_2.25/house_of_roman.c) | Leakless technique in order to gain remote code execution via fake fastbins, the unsorted_bin attack and relative overwrites. | |
