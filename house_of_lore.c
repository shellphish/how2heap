...
int main(int argc, char * argv[]){
  ...
  //stack_buffer_2[0] = (intptr_t*)stack_buffer_1;
  //stack_buffer_2[1] = (intptr_t*)stack_buffer_1;
  ...
  stack_buffer_2[2] = (intptr_t*)stack_buffer_1;
	...
	printf("Allocated the large chunk on the heap at %#x\n", p5);
	...
	printf("The chunk that can't be handled by the unsorted bin, nor the SmallBin has been allocated to %#x\n", p2);
  ...
  printf("\nThe fwd pointer of stack_buffer_2 has changed after the last malloc to %p\n",
	...
	printf("\np4 is %#x and should be on the stack\n", p4); // this chunk will be allocated on stack
